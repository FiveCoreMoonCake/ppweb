...
const g2: CharItem[] = [
  ...
  { char: "子", readings: [
    { pinyin: "zǐ", words: ["子女", "子弹"], emoji: "👶" },
    { pinyin: "zi", words: ["儿子", "桌子"], emoji: "🪑" },
  ], groupId: "g2" },
...
const g3: CharItem[] = [
  ...
  { char: "石", readings: [{ pinyin: "shí", words: ["石头", "山石"], emoji: "🪨" }], groupId: "g3" },
...
const g4: CharItem[] = [
  { char: "上", readings: [{ pinyin: "shàng", words: ["上下", "上山"], emoji: "⬆️" }], groupId: "g4" },
...
const g5: CharItem[] = [
  ...
  { char: "见", readings: [{ pinyin: "jiàn", words: ["看见", "再见"], emoji: "👀" }], groupId: "g5" },
